rec {
  ...
  makeExtensible = makeExtensibleWithCustomName "extend" fix';

  # Same as `makeExtensible` but the name of the extending attribute is
  # customized.
  makeExtensibleWithCustomName = extenderName: extenderFun: rattrs:
    extenderFun rattrs // {
      ${extenderName} = f: makeExtensibleWithCustomName extenderName extenderFun (extends f rattrs);
    };
